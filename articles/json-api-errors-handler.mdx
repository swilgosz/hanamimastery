When some time ago I came with an [advanced way of handling exceptions in Ruby Applications](https://driggl.com/blog/handling-exceptions-in-rails-applications) I realized, that this is a wider problem than I thought. A lot of people found the idea very useful and therefore I decided to go with this topic even further.
