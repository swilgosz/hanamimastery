...
I've wrote about the[ ruby implementation of CQRS in the separate article](https://driggl.com/blog/cars-api-endpoints-in-rails-applications). Here I'll focus on more high-level content.
...
This, however, requires us to implement the [Trigger Pattern](https://hawkins6423.github.io/) or similar, additional abstraction layer which generates [more code to be written](https://driggl.com/blog/why-we-are-not-dry).
