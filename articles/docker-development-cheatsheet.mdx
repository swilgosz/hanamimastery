In the last article, I've written about [the reasons for choosing Docker](https://driggl.com/blog/docker-setup-for-rails-development) in my daily workflow of creating web applications.
...
> The detailed configuration for my flow I've described in the [previous article](https://driggl.com/blog/docker-setup-for-rails-development), feel free to check it out.
