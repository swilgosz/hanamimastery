[CQRS in the API](https://driggl.com/blog/cqrs-rest-api) applications may be tricky at the start, but it is an amazing pattern to write complicated, scalable systems.
