...
This will rename all the occurences of the default AppPrototypeTest with the sandbox in this case.
...
Yaay! You can see "Welcome to, sanbox!" message.
...
Now I'll restart the serwer and in the browser we can see the updated text. Amazing!
...
Unfortunately, when apps grow, Rails default architecture become problematic.
...
PS: If you have any comments how to improve HanamiMastery concept, tweet me or add a comment below, It will really help me to make these contents better.
