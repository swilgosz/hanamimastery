...
On the module level, you need to extend the ___Dry::Configurable__ module and you can safely use all features it provides. Here I set the `api_url to hanamimastery.com`
...
It's super useful, and I include [[dry-configurable|Dry::Configurable]] in almost every gem or service I create, because of it's flexibility.
