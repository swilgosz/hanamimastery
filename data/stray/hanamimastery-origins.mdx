...
author: "swilgosz"
tags: ["open-source"]
title: "My attempt to change the worlds of Open-Source financing."
...
I've first met Piotr around 2015 on one conferenece in Wrocław, where he presented the [ROM.rb](rom-rb.org) updates, and I was still kind of a junior-level ruby developer up there. I saw what hi did in this library and I was amazed. Shocked, and amazed.
...
At that point I didn't look to develop my personal, unique being as a Ruby developer. I rather looked for several people I admired and thought: "I want to be like these guys!". This obviously was not a way to go, but I needed some time to realise, that everybody is different - even if some thoughts, skills or opinions are common.
...
Number one I had since the beginning was that I needed to work full-time to support my family. When you work 8 hours, you sleep 8 hours, You have 2 hours for all the meals, there are 6 hours left in the day....

I wanted to share as much time as possible betwen my kids, lovely wife, and not forgetting about time for myself. And at the same time, I wanted to work on online contributions, like blogging, open-source activity, online teaching...
...
1. I've thrown away 25% of my income just to make work for free for others to profit from it.
...
Then github sponsors came alive, and I quickly checked, if is it only me, or are other people struggle with financing their Open-Source work too?

Here is how things look in the mid of June 2021:

![[/public/images/hanamimastery-origins/solnic-sponsors-2021.png]]

![[/public/images/hanamimastery-origins/timriley-sponsors-2021.png]]

![[/public/images/hanamimastery-origins/jodosha-sponsors-2021.png]]

![[bbatsov-sponsors-2021.png]]
...
Here is where [HanamiMastery](https://hanamimastery.com) is born.
...
2. **The core team is too small** - because people need to earn money for their lives. They usually cannot afford to work for free too much. SO I'm giving off at least of 10% of ALL income I'll make in any way, related to HanamiMastery, directly to support maintainers of libraries Hanami relies on, directly or indirectly.
