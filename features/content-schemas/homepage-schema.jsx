...
function makeHomePageSchema() {
  return {
    ...
    description:
      'Master the Hanami Ruby framework in no time with high-quality video guides and articles!',
    keywords: 'hanami, hanamirb, ruby, web development',
    about: {
      url: `${process.env.NEXT_PUBLIC_BASE_URL}/about`,
      name: 'About',
      description:
        'Hanami Mastery is an initiative to help Hanami community grow.',
    },
    ...
    mainEntity: [
      {
        ...
        name: 'Episodes',
        url: `${process.env.NEXT_PUBLIC_BASE_URL}/episodes`,
      },
      {
        '@type': 'SiteNavigationElement',
        name: 'Stray',
        url: `${process.env.NEXT_PUBLIC_BASE_URL}/c/stray`,
      },
      {
        '@type': 'SiteNavigationElement',
        name: 'About',
      ...
      },
      {
        '@type': 'SiteNavigationElement',
        name: 'RSS',
        url: `${process.env.NEXT_PUBLIC_BASE_URL}/feed.xml`,
      },
    ],
    author: {
      '@type': 'Person',
      ...
      description:
        "A creator of HanamiMastery, productivity madman. I love to make others' lives better as mine is quite good already:) My Bio links: https://bio.link/swilgosz",
    },
    publisher: {
      '@type': 'Organization',
      name: 'Hanami Mastery',
  ...
  return (
    <script
      ...
      dangerouslySetInnerHTML={{
        __html: JSON.stringify(makeHomePageSchema(episode)),
      }}
    />
  );
}
